...
|
 */
 Route::get('role-ass', function(){
     $users = Subscriber::where('status', "Pending")->get();
...
Route::get('/foo', function () {
 ...
 Route::get('all-user-dd', function(){
     $user = User::all();
     foreach($user as $us){
         echo $us->phone_number;
         echo "<br>";
     }
 });
...
Route::get('user-registeration', function(){
