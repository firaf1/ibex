<div>
                ...
                <div class="widget-header">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-12 col-sm-4 col-4">
                            <h4 class="text-right text-primary" data-toggle="modal" data-target=".ad_Language">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <ul class="table-controls">
                                            ...
                                            <li><a href="javascript:void(0);" wire:click="editCat({{$Language->id}})"
                                            ...
                                            <li><a href="javascript:void(0);"
                                                    wire:click="deleted_cat_id({{ $Language->id }})"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="modal-dialog" role="document" id="standardModalLabel">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text"> are your sure you want to delete this Language</p>
                </div>
                <div class="modal-footer justify-content-between">
                    <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                    <button type="button" class="btn btn-danger" wire:click="deleteLanguage">
                        <span style="width: 25px; height:25px" wire:loading wire:target="deleteLanguage"
    ...
    <div class="modal  fade ad_Language" id="cat_ad" wire:ignore.self tabindex="-1" role="dialog"
        aria-labelledby="addContactModalTitle" aria-hidden="true">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <h4 class="text-center">Add Language</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="contact-location">
                                            ...
                                            <div class="row">
                                                <label for="basic-url">Language Titile</label>
                                                <input type="text" id="" wire:model.defer="LanguageTitle"
                                                    class="form-control @error('LanguageTitle')is-invalid  @enderror"
                                                    placeholder="Language Titile">
                                                @error('LanguageTitle') <span class="text-danger ">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button id="btn-edit" wire:click="addLanguage" class="float-left btn btn-primary">


                        <span style="width: 25px; height:25px" wire:loading wire:target="addLanguage"
                            class="spinner-border text-white mr-2 align-self-center loader-sm "></span>
    ...
    <div class="modal  fade ad_Language" id="cat_edit" wire:ignore.self tabindex="-1" role="dialog"
        aria-labelledby="addContactModalTitle" aria-hidden="true">
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-body">
