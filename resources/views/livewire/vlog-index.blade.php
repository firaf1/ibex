<div>
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <div class="d-flex justify-content-sm-end justify-content-center">
                            ...
                            <a href=" {{route('addVlog')}} " class="btn btn-primary mb-2 mr-2" >
                    ...
                    <table class="table table-bordered table-striped table-hover mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <a href=""> {!! $vlog->title !!} </a> </td>
                                <td>
                                <span class="badge badge-dark">   {{ $vlog->user->full_name }} </span> 
                              </td>
                                <td class="text-center"><span class="badge badge-success">{{ $vlog->language->language }}</span></td>
                                <td> {{ $vlog->category->title }} </td>
                                <td class="text-center">
                                    <div class="btn-group ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btndefault"
                                            ...
                                            <a wire:click="aprroveVlog({{$vlog->id}})" href="javascript:void(0);"
                                                class="dropdown-item"><i
                                                    class="flaticon-home-fill-1 mr-1"></i>Approved</a>
                                            <a wire:click="blockVlog({{$vlog->id}})" href="javascript:void(0);"
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1"
                                            ...
                                            <a class="dropdown-item"  href="edit-vlog/{{$vlog->id}}">Edit</a>
                                            <a class="dropdown-item" wire:click="deletedId({{$vlog->id}})"
    ...
    <!-- Deleted Modal -->
    <div class="modal fade modal-notification show" id="vlogDeletedModal" wire:ignore.self tabindex="-1"
    ...
    <div class="modal  fade editVlogModal show" id="editVlogModal" wire:ignore.self tabindex="-1"
        aria-labelledby="myExtraLargeModalLabel" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Add Vlog</h5>
    ...
    <div class="modal  fade bd-example-modal-xl show" id="vlogModal" wire:ignore.self tabindex="-1"
        aria-labelledby="myExtraLargeModalLabel" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
