                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @elseif($phonenumber1->status == "Pending")
                                        <span class="badge badge-success">{{ $phonenumber1->status }}</span>
                                        @else 
                                        <span class="badge badge-primary">{{ $phonenumber1->status }}</span>
                                        @endif
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    ...
                    <div class="input-group mb-4">
                                        ...
                                        <input type="text" wire:model.defer="phoneNumber" id="subInput" class="form-control  @error('phoneNumber')is-invalid  @enderror" placeholder="Phone Number" aria-label="dropdown">
                                        <br>
                                     
                                    </div>
                                    <p id="sub_err" style="display:none; color:red; "  >  </p>
