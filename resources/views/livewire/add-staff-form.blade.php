   ...
   <div class="col-md-12 col-sm-12">    
            <div class="card card-box">
                ...
                <div class="card-body " id="bar-parent">           
                    ...
                    @if(!$isUpload)
                    <img src="back/img/no-image.png"    style="width:76%; height:70%; border-radius:50%; border: 2px solid #188ae2;" alt="" srcset="">
                    
                    @else 
                     <img src="{{ $photo->temporaryUrl() }}"  style="width:76%; height:70%; border-radius:50%; border: 2px solid #188ae2;" alt="" srcset="">
                     @endif
                    ...
                    <input type="file" wire:model.defer="photo" name="" id="photo" hidden >
                        ...
                        <span class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored margin-right-10" data-upgraded=",MaterialButton">
