        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="form-group mb-3">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <input name="image" name="file" type="file" class="form-control @error('image')is-invalid  @enderror" id="inputEmail4" placeholder="Thumblen">
                    ...
                    <button onclick="updateValue()" type="submit" class="btn btn-primary mb-4 mr-2 btn-lg">Submit </button>
                    </div>
                    </form>
            </div>
